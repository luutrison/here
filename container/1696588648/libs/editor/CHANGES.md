...
* [#5158](https://github.com/ckeditor/ckeditor4/issues/5158): Fixed: [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools#convertToPx()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-convertToPx) gives invalid results if the helper calculator element was deleted from the DOM.
...
* [#4641](https://github.com/ckeditor/ckeditor4/issues/4641): Added an option allowing to cancel the [Delayed Editor Creation](https://ckeditor.com/docs/ckeditor4/latest/features/delayed_creation.html) feature as a function handle for editor creators ([`X_EDITOR_DJE2OTY3MDAYNJK4MTA.replace`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-replace), [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.inline`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-inline), [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.appendTo`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-appendTo)).
...
* [#5097](https://github.com/ckeditor/ckeditor4/issues/5097): [Chrome] Fixed: Incorrect conversion of points to pixels while using [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.convertToPx()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-convertToPx).
...
* [#5127](https://github.com/ckeditor/ckeditor4/issues/5127): Deprecated the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.rnd`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#property-rnd) property to discourage using it in a security-sensitive context.
...
* [#4761](https://github.com/ckeditor/ckeditor4/issues/4761): The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.appendTimestamp()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-appendTimestamp) function was added.
* [#4761](https://github.com/ckeditor/ckeditor4/issues/4761): [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.document#appendStyleSheet()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_document.html#method-appendStyleSheet) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.buildStyleHtml()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-buildStyleHtml) now use the newly added [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.appendTimestamp()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-appendTimestamp) function to correctly handle caching of CSS files.
...
* [#4596](https://github.com/ckeditor/ckeditor4/issues/4596): Fixed: Incorrect handling of HSL/HSLA values in [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.color`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_color.html).
* [#4597](https://github.com/ckeditor/ckeditor4/issues/4597): Fixed: Incorrect color conversion for HSL/HSLA values in [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.color`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_color.html).
* [#4604](https://github.com/ckeditor/ckeditor4/issues/4604): Fixed: [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.clipboard.dataTransfer#getTypes()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_clipboard_dataTransfer.html#method-getTypes) returns no types.
...
* [#4888](https://github.com/ckeditor/ckeditor4/issues/4888): Fixed: The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dialog#setState()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dialog.html#method-setState) method throws error when there is no "OK" button in the dialog.
...
* [#4462](https://github.com/ckeditor/ckeditor4/issues/4462): [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.editor#getSelection()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-getSelection) now returns `null` if the editor is in recreating state.
* [#4583](https://github.com/ckeditor/ckeditor4/issues/4583): Added support for new, comma-less color syntax to [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.color`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_color.html).
* [#4604](https://github.com/ckeditor/ckeditor4/issues/4604): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.clipboard.dataTransfer#isFileTransfer()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_clipboard_dataTransfer.html#method-isFileTransfer) method.
* [#4790](https://github.com/ckeditor/ckeditor4/issues/4790): Added `callback` parameter to [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.preview#createPreview()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_preview.html#method-createPreview) method.
...
* [#4659](https://github.com/ckeditor/ckeditor4/issues/4659): Fixed: [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_htmlParser.html) does not treat `--!>` as a comment end tag correctly.
...
* [#4358](https://github.com/ckeditor/ckeditor4/issues/4358): Introduced the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.color`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_color.html) class which adds colors validation and methods for converting colors between various formats: named colors, HEX, RGB, RGBA, HSL and HSLA.
* [#3782](https://github.com/ckeditor/ckeditor4/issues/3782): Moved the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.pastetools.filters.word.images`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_pastetools_filters_word_images.html) filters to the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.pastetools.filters.image`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_pastetools_filters_image.html) namespace.
* [#4297](https://github.com/ckeditor/ckeditor4/issues/4297): All [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.pastetools.filters`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_pastetools_filters.html) are now available under the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.pasteTools`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#property-pasteTools) alias.
* [#4394](https://github.com/ckeditor/ckeditor4/issues/4394): Introduced [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ajax`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ajax.html) specialized loading methods for loading binary ([`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ajax.loadBinary()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ajax.html#method-loadBinary)) and text ([`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ajax.loadText()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ajax.html#method-loadText)) data.
...
* [#4293](https://github.com/ckeditor/ckeditor4/issues/4293): Fixed: The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.inlineAll()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-inlineAll) method tries to initialize inline editor also on elements with an editor already attached to them.
...
* [#4273](https://github.com/ckeditor/ckeditor4/issues/4273): Fixed: A memory leak in the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.domReady()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-domReady) method connected with not removing `load` event listeners. Thanks to [rohit1](https://github.com/rohit1)!
...
* [#3387](https://github.com/ckeditor/ckeditor4/issues/3387): Added the [X_EDITOR_DJE2OTY3MDAYNJK4MTA.ui.richCombo.select()](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ui_richCombo.html#method-select) method.
...
* [#3593](https://github.com/ckeditor/ckeditor4/issues/3593): Fixed: Cannot access a text or comment node when replacing an element node with them via [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_htmlParser_filter.html).
...
* [#3552](https://github.com/ckeditor/ckeditor4/issues/3352): Fixed: Incorrect value of [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.widget.repository#selected`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_repository.html#property-selected) after selecting the whole editor content.
...
* [#3634](https://github.com/ckeditor/ckeditor4/issues/3634): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.clipboard.dataTransfer#getTypes()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_clipboard_dataTransfer.html#method-getTypes) method.
...
* [#3101](https://github.com/ckeditor/ckeditor4/issues/3101): Fixed: [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.range#_getTableElement()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_range.html#method-_getTableElement) returns `null` instead of a table element for edge cases.
* [#3287](https://github.com/ckeditor/ckeditor4/issues/3287): Fixed: [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.promise`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_promise.html) initializes incorrectly if an AMD loader is present.
* [#3379](https://github.com/ckeditor/ckeditor4/issues/3379): Fixed: Incorrect [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.editor#getData()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-getData) call when inserting content into the editor.
...
* [#3381](https://github.com/ckeditor/ckeditor4/issues/3381): [IE8] Fixed: The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.object.keys()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_object.html#method-keys) method does not accept non-objects.
...
* [#3154](https://github.com/ckeditor/ckeditor4/issues/3154): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.array.some()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_array.html#method-some) method.
* [#3245](https://github.com/ckeditor/ckeditor4/issues/3245): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.undo.UndoManager.addFilterRule()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_undo_UndoManager.html#method-addFilterRule) method that allows filtering undo snapshot contents.
* [#2845](https://github.com/ckeditor/ckeditor4/issues/2845): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.normalizeMouseButton()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-normalizeMouseButton) method.
* [#2975](https://github.com/ckeditor/ckeditor4/issues/2975): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.element#fireEventHandler()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_element.html#method-fireEventHandler) method.
* [#3247](https://github.com/ckeditor/ckeditor4/issues/3247): Extended the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.bind()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-bind) method to accept arguments for bound functions.
* [#3326](https://github.com/ckeditor/ckeditor4/issues/3326): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.text#isEmpty()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_text.html#method-isEmpty) method.
* [#2423](https://github.com/ckeditor/ckeditor4/issues/2423): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.dialog.getModel()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dialog.html#method-getModel) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.dialog.getMode()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dialog.html#method-getMode) methods with their [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugin.definition`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dialog_definition.html) counterparts, allowing to get the dialog subject of a change.
* [#3124](https://github.com/ckeditor/ckeditor4/issues/3124): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.element#isDetached()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_element.html#method-isDetached) method.
...
* [#2923](https://github.com/ckeditor/ckeditor4/issues/2923): Fixed: The CSS `windowtext` color is not correctly recognized by the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.style.parse`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_style_parse.html) methods.
* [#3120](https://github.com/ckeditor/ckeditor4/issues/3120): [IE8] Fixed: The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.extend()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tool.html#method-extend) method does not work with the [`DontEnum`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Properties) object property attribute.
...
* [#2751](https://github.com/ckeditor/ckeditor4/issues/2751): Fixed: An editor with [`config.enterMode`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-enterMode) set to [`ENTER_DIV`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#property-ENTER_DIV) alters pasted content.

API Changes:

* [#1496](https://github.com/ckeditor/ckeditor4/issues/1496): The [Balloon Toolbar](https://ckeditor.com/cke4/addon/balloontoolbar) plugin exposes the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ui.balloonToolbar.reposition()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ui_balloonToolbar.html#reposition) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ui.balloonToolbarView.reposition()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ui_balloonToolbarView.html#reposition) methods.
* [#2021](https://github.com/ckeditor/ckeditor4/issues/2021): Added new [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.documentFragment.find()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_documentFragment.html#method-find) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.documentFragment.findOne()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_documentFragment.html#method-findOne) methods.
* [#2700](https://github.com/ckeditor/ckeditor4/issues/2700): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.array.find()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_array.html#method-find) method.
* [#3123](https://github.com/ckeditor/ckeditor4/issues/3123): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.object.keys()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_object.html#method-keys) method.
* [#3123](https://github.com/ckeditor/ckeditor4/issues/3123): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.object.entries()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_object.html#method-entries) method.
* [#3123](https://github.com/ckeditor/ckeditor4/issues/3123): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.object.values()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_object.html#method-values) method.
* [#2821](https://github.com/ckeditor/ckeditor4/issues/2821): The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.template#source`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_template.html#property-source) property can now be a function, so it can return the changed template values during the runtime. Thanks to [Jacek Pulit](https://github.com/jacek-pulit)!
* [#2598](https://github.com/ckeditor/ckeditor4/issues/2598): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.pagebreak.createElement()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_pagebreak.html#method-createElement) method allowing to create a [Page Break](https://ckeditor.com/cke4/addon/pagebreak) plugin [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.element`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_element.html) instance.
...
* [#2698](https://github.com/ckeditor/ckeditor4/issues/2698): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.element.findOne()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_htmlParser_element.html#method-findOne) method.
* [#2935](https://github.com/ckeditor/ckeditor4/issues/2935): Introduced the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.config.pasteFromWord_keepZeroMargins`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-pasteFromWord_keepZeroMargins) configuration option that allows for keeping any `margin-*: 0` style that would be otherwise removed when pasting content with the [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin.
* [#2962](https://github.com/ckeditor/ckeditor4/issues/2962): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.promise`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_promise.html) class.
* [#2924](https://github.com/ckeditor/ckeditor4/issues/2924): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.style.border`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_style_border.html) object wrapping CSS border style helpers under a single type.
...
* Updated [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) and [SpellCheckAsYouType](https://ckeditor.com/cke4/addon/scayt) (SCAYT) plugins:
	...
	* [#55](https://github.com/WebSpellChecker/ckeditor-plugin-wsc/issues/55): Fixed: WSC does not use [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.getUrl()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-getUrl) when referencing style sheets.
	* [#166](https://github.com/WebSpellChecker/ckeditor-plugin-scayt/issues/166): Fixed: SCAYT does not use [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.getUrl()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-getUrl) when referencing style sheets.
...
* [#1722](https://github.com/ckeditor/ckeditor4/issues/1722): [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.instances`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#static-property-instances) is causing memory leaks.
...
* [#2453](https://github.com/ckeditor/ckeditor4/issues/2453): The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ui.panel.block.getItems`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ui_panel_block.html#method-getItems) method now also returns `input` elements in addition to links.
* [#2224](https://github.com/ckeditor/ckeditor4/issues/2224):  The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.convertToPx`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-convertToPx) function now converts negative values.
...
* [#2466](https://github.com/ckeditor/ckeditor4/issues/2466):  The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-constructor) constructor accepts an additional `rules` parameter allowing to bind the editor and filter together.
...
* [#1751](https://github.com/ckeditor/ckeditor4/issues/1751): Introduced the **Autocomplete** feature that consists of the following plugins:
	...
	* [Text Match](https://ckeditor.com/cke4/addon/textMatch) &ndash; Allows to search [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.range`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_range.html) for matching text.
...
* [#1748](https://github.com/ckeditor/ckeditor4/pull/1748): Fixed: Missing [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dialog.definition.onHide`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dialog_definition.html#property-onHide) API documentation. Thanks to [sunnyone](https://github.com/sunnyone)!
...
* [#1582](https://github.com/ckeditor/ckeditor4/issues/1582): The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.editor.addCommand()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-addCommand) method can now accept a [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.command`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_command.html) instance as a parameter.
...
* [#1498](https://github.com/ckeditor/ckeditor4/issues/1498) : Added a new [`getClientRects()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_range.html#method-getClientRects) method to `X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.range`. It returns a list of rectangles for each selected element.
* [#1993](https://github.com/ckeditor/ckeditor4/issues/1993): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.throttle()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-throttle) function.
...
* [#1399](https://github.com/ckeditor/ckeditor4/issues/1399): Added the possibility to set [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.config.startupFocus`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-startupFocus) as `start` or `end` to specify where the editor focus should be after the initialization.
...
* [#856](https://github.com/ckeditor/ckeditor4/issues/856): Introduced the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.keystrokeToArray()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-keystrokeToArray) method. It converts a keystroke into its string representation, returning every key name as a separate array element.
* [#1053](https://github.com/ckeditor/ckeditor4/issues/1053): Introduced the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.object.merge()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_object.html#method-merge) method. It allows to merge two objects, returning the new object with all properties from both objects deeply cloned.
* [#1073](https://github.com/ckeditor/ckeditor4/issues/1073): Introduced the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.array.every()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools_array.html#method-every) method. It invokes a given test function on every array element and returns `true` if all elements pass the test.
...
* [#994](https://github.com/ckeditor/ckeditor4/pull/994): Fixed: Typo in the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.focusManager.focus()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_focusManager.html#method-focus) API documentation. Thanks to [benjy](https://github.com/benjy)!
...
* [#1068](https://github.com/ckeditor/ckeditor4/issues/1068): Fixed: Upload widget paste listener ignores changes to the [`uploadWidgetDefinition`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.fileTools.uploadWidgetDefinition.html).
...
* [#1145](https://github.com/ckeditor/ckeditor4/issues/1145): Added the [`skipNotifications`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_fileTools_uploadWidgetDefinition.html#property-skipNotifications) option to the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.fileTools.uploadWidgetDefinition`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.fileTools.uploadWidgetDefinition.html), allowing to switch off default notifications displayed by upload widgets.
...
* [#568](https://github.com/ckeditor/ckeditor4/issues/568): Added possibility to adjust nested editables' filters using the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.disallowedContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#property-disallowedContent) property.
...
* [#423](https://github.com/ckeditor/ckeditor4/issues/423): Fixed: The [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin pastes paragraphs into the editor even if [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.config.enterMode`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-enterMode) is set to `X_EDITOR_DJE2OTY3MDAYNJK4MTA.ENTER_BR`.
...
* [#800](https://github.com/ckeditor/ckeditor4/issues/800): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.selection.isCollapsed()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_selection.html#method-isCollapsed) method which is a simpler way to check if the selection is collapsed.
* [#830](https://github.com/ckeditor/ckeditor4/issues/830): Added an option to define which dialog tab should be shown by default when creating [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dialogCommand`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.dialogCommand.html).
...
* [#751](https://github.com/ckeditor/ckeditor4/issues/751): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.nodeList.toArray()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_nodeList.html#method-toArray) method which returns an array representation of a [node list](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.nodeList.html).
...
* [#450](https://github.com/ckeditor/ckeditor4/issues/450): Fixed: [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.html) incorrectly transforms the `margin` CSS property.
...
* [#13381](https://dev.ckeditor.com/ticket/13381): Dynamic code evaluation call in [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.template`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.template.html) removed. CKEditor can now be used without the `unsafe-eval` Content Security Policy. Thanks to [Caridy Patiño](http://caridy.name)!
...
* [#16937](https://dev.ckeditor.com/ticket/16937): The `command` parameter in [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.editor.getCommandKeystroke()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-getCommandKeystroke) now also accepts a command name as an argument.
* [#17010](https://dev.ckeditor.com/ticket/17010): The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.range.shrink()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_range.html#method-shrink) method now allows for skipping bogus `<br>` elements.
...
* [PR#336](https://github.com/ckeditor/ckeditor4/pull/336): Fixed: Typo in [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.getCss()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-getCss) API documentation. Thanks to [knusperpixel](https://github.com/knusperpixel)!
...
* [#16639](https://dev.ckeditor.com/ticket/16639): The `callback` parameter in the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ajax.post()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_ajax.html#method-post) method became optional.
...
* [#8983](https://dev.ckeditor.com/ticket/8983): Fixed: Alignment lost when [pasting from Word](https://ckeditor.com/cke4/addon/pastefromword) with [`config.enterMode`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-enterMode) set to [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ENTER_BR`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#property-ENTER_BR).
...
* [#13886](https://dev.ckeditor.com/ticket/13886): Fixed: Invalid handling of the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.style`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.html) instance with the `styles` property by [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.html).
...
* [#11725](https://dev.ckeditor.com/ticket/11725): Marked [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.env.mobile`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_env.html#property-mobile) as deprecated. The reason is that it is no longer clear what "mobile" means.
...
* [#13528](https://dev.ckeditor.com/ticket/13528): [Firefox@Windows] Fixed: Content copied from Microsoft Word and other external applications is pasted as a plain text. Removed the `X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.clipboard.isHtmlInExternalDataTransfer` property as the check must be dynamic.
...
* [#13105](https://dev.ckeditor.com/ticket/13105): Fixed: Various issues related to [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.htmlEncode()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-htmlEncode) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.htmlDecode()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-htmlDecode) methods.
...
* [#13316](https://dev.ckeditor.com/ticket/13316): Made [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.env.isCompatible`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_env.html#property-isCompatible) a blacklist rather than a whitelist. More about the change in the [Browser Compatibility](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_browsers.html) guide.
* [#13398](https://dev.ckeditor.com/ticket/13398): Renamed `X_EDITOR_DJE2OTY3MDAYNJK4MTA.fileTools.UploadsRepository` to [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.fileTools.UploadRepository`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.fileTools.uploadRepository.html) and changed all related properties.
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).
  ...
  * Major features:
    ...
    * The [Data Transfer](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.clipboard.dataTransfer.html) facade was introduced to unify access to data in various types and files. [Data Transfer](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.clipboard.dataTransfer.html) is now always available in the [`editor#paste`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#event-paste) event.
...
* Notification system:
  * [#11580](https://dev.ckeditor.com/ticket/11580): Introduced the [notification system](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.notification.html).
  * [#12810](https://dev.ckeditor.com/ticket/12810): Introduced a [notification aggregator](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.notificationAggregator.html) for the [notification system](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.notification.html) which simplifies displaying progress of many concurrent tasks.
...
* [#12770](https://dev.ckeditor.com/ticket/12770): Added support for passing [widget](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.widget.html)'s startup data as a widget command's argument. Thanks to [Rebrov Boris](https://github.com/zipp3r) and [Tieme van Veen](https://github.com/tiemevanveen)!
...
* [#13268](https://dev.ckeditor.com/ticket/13268): Fixed: Documentation for [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.text`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.dom.text.html) is incorrect. Thanks to [Ben Kiefer](https://github.com/benkiefer)!
...
* [PR#192](https://github.com/ckeditor/ckeditor4/pull/192): Fixed: Variable name typo in the [Dialog User Interface](https://ckeditor.com/cke4/addon/dialogui) plugin which caused [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ui.dialog.radio`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.ui.dialog.radio.html) validation to not work. Thanks to [Florian Ludwig](https://github.com/FlorianLudwig)!
...
* [#13233](https://dev.ckeditor.com/ticket/13233): Fixed: [HTMLDataProcessor](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlDataProcessor.html) can process `foo:href` attributes.
...
* [#12550](https://dev.ckeditor.com/ticket/12550): Added the `<main>` element to the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dtd`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.dtd.html).
...
* [#12688](https://dev.ckeditor.com/ticket/12688): Improved the tests of the [styles system](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.html) and fixed two minor issues.
...
* [#12261](https://dev.ckeditor.com/ticket/12261): Fixed: The filter is not destroyed and removed from [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.instances`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_filter.html#static-property-instances) on editor destroy.
...
* [#11911](https://dev.ckeditor.com/ticket/11911): Fixed setting the `dir` attribute for a preloaded language in [X_EDITOR_DJE2OTY3MDAYNJK4MTA.lang](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.lang.html). Thanks to [Akash Mohapatra](https://github.com/akashmohapatra)!
...
* [#11788](https://dev.ckeditor.com/ticket/11788): Fixed: [Filter](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.filter.html) rules are not applied inside elements with the `contenteditable` attribute set to `true`.
...
* Since CKEditor 4.4 the editor instance should be passed to [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.style`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.html) methods to ensure full compatibility with other features (e.g. applying styles to widgets requires that). We ensured backward compatibility though, so the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.style`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.html) will work even when the editor instance is not provided.
...
* [#11297](https://dev.ckeditor.com/ticket/11297): Styles can now be applied to widgets. The definition of a style which can be applied to a specific widget must contain two additional properties &mdash; `type` and `widget`. Read more in the [Widget Styles](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_styles.html#widget-styles) section of the "Styles Drop-down" guide. Note that by default, widgets support only classes and no other attributes or styles. Related changes and features:
  * Introduced the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.addCustomHandler()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_style.html#static-method-addCustomHandler) method for registering custom style handlers.
  * The [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.apply()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_style.html#method-apply) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.remove()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_style.html#method-remove) methods are now called with an editor instance instead of the document so they can be reused by the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.editor.applyStyle()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-applyStyle) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.editor.removeStyle()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-removeStyle) methods. Backward compatibility was preserved, but from CKEditor 4.4 it is highly recommended to pass an editor instead of a document to these methods.
  * Many new methods and properties were introduced in the [Widget API](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.widget.html) to make the handling of styles by widgets fully customizable. See: [`widget.definition.styleableElements`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_definition.html#property-styleableElements), [`widget.definition.styleToAllowedContentRule`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget_definition.html#property-styleToAllowedContentRules), [`widget.addClass()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget.html#method-addClass), [`widget.removeClass()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget.html#method-removeClass), [`widget.getClasses()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget.html#method-getClasses), [`widget.hasClass()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget.html#method-hasClass), [`widget.applyStyle()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget.html#method-applyStyle), [`widget.removeStyle()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget.html#method-removeStyle), [`widget.checkStyleActive()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_plugins_widget.html#method-checkStyleActive).
  * Integration with the [Allowed Content Filter](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_advanced_content_filter.html) required an introduction of the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.style.toAllowedContent()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_style.html#method-toAllowedContentRules) method which can be implemented by the custom style handler and if exists, it is used by the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.html) to translate a style to [allowed content rules](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.allowedContentRules.html).
...
* [#11536](https://dev.ckeditor.com/ticket/11536): Added the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.htmlDecode()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-htmlDecode) method for decoding HTML entities.
* [#11225](https://dev.ckeditor.com/ticket/11225): Introduced the [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.transparentImageData`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#property-transparentImageData) property which contains transparent image data to be used in CSS or as image source.
...
* [#11508](https://dev.ckeditor.com/ticket/11508): Fixed: [`htmlDataProcessor`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlDataProcessor.html) discovering protected attributes within other attributes' values.
...
* [#11390](https://dev.ckeditor.com/ticket/11390): [IE] All [XML](https://ckeditor.com/cke4/addon/xml) plugin [methods](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.xml.html) now work in IE10+.
...
* [#11102](https://dev.ckeditor.com/ticket/11102): `X_EDITOR_DJE2OTY3MDAYNJK4MTA.template` improvements:
...
* [#11350](https://dev.ckeditor.com/ticket/11350): The default value of [`config.contentsCss`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-contentsCss) is affected by [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.getUrl()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-getUrl).
...
* [#9764](https://dev.ckeditor.com/ticket/9764): Widget System.
  * [Widget plugin](https://ckeditor.com/cke4/addon/widget) introducing the [Widget API](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.widget.html).
  ...
  * Default [`htmlParser.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.filter.html) rules are not applied to non-editable elements (elements with `contenteditable` attribute set to `false` and their descendants) anymore. To add a rule which will be applied to all elements you need to pass an additional argument to the [`filter.addRules()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_htmlParser_filter.html#method-addRules) method.
  * Dozens of new methods were introduced &ndash; most interesting ones:
      ...
      * New methods for [`htmlParser.node`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.node.html) and [`htmlParser.element`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.element.html).
...
* [#10913](https://dev.ckeditor.com/ticket/10913): Fixed [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.addExternal()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_resourceManager.html#method-addExternal) not handling paths including file name specified.
* [#10666](https://dev.ckeditor.com/ticket/10666): Fixed [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.tools.isArray()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-isArray) not working cross frame.
...
* [#10610](https://dev.ckeditor.com/ticket/10610): [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.dialog.addIframe()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dialog.html#static-method-addIframe) incorrectly sets the iframe size in dialog windows.
...
* [#10146](https://dev.ckeditor.com/ticket/10146): [Firefox] Empty lines are being removed while [`config.enterMode`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-enterMode) is [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.ENTER_BR`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#property-ENTER_BR).
...
* [#9995](https://dev.ckeditor.com/ticket/9995): HTML code in the `<textarea>` should not be modified by the [`htmlDataProcessor`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlDataProcessor.html).
...
* [#10315](https://dev.ckeditor.com/ticket/10315): [WebKit] [Undo manager](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.plugins.undo.UndoManager.html) should not record snapshots after a filling character was added/removed.
...
* [#9829](https://dev.ckeditor.com/ticket/9829): Advanced Content Filter - data and features activation based on editor configuration.
  ...
  * Based on [`config.allowedContent`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-allowedContent) rules - the data
  ...
  See the `datafiltering.html` sample, [guides](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_advanced_content_filter.html) and [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter` API documentation](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.filter.html).
...
* [#9907](https://dev.ckeditor.com/ticket/9907): Added the [`contentPreview`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#event-contentPreview) event for preview data manipulation.
...
* [#9981](https://dev.ckeditor.com/ticket/9981): Added ability to filter [`htmlParser.fragment`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.fragment.html), [`htmlParser.element`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.element.html) etc. by many [`htmlParser.filter`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.htmlParser.filter.html)s before writing structure to an HTML string.
* Included in [#10103](https://dev.ckeditor.com/ticket/10103):
  ...
  * Default [`command`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.command.html) state is now [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.TRISTATE_DISABLE`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#property-TRISTATE_DISABLED). It will be activated on [`editor.instanceReady`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#event-instanceReady) or immediately after being added if the editor is already initialized.
...
* [#9779](https://dev.ckeditor.com/ticket/9779): Fixed overriding [`X_EDITOR_DJE2OTY3MDAYNJK4MTA.getUrl()`](https://ckeditor.com/docs/ckeditor4/latest/api/X_EDITOR_DJE2OTY3MDAYNJK4MTA.html#method-getUrl) with `CKEDITOR_GETURL`.
